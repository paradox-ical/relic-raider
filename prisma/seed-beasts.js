...
const beastsData = [
  ...
  { name: "Barbed Construct of Aztec", description: "A legendary barbed construct of stone and magic.", baseHp: 350, baseAttack: 22, baseDefense: 12, rarity: "LEGENDARY", lootDrops: ["Echoing Horn", "Fireheart Gem", "Runic Blade"] },
  ...
  { name: "Savage Construct of Aztec", description: "A mythic construct of pure destruction.", baseHp: 500, baseAttack: 30, baseDefense: 18, rarity: "MYTHIC", lootDrops: ["Mythic Beast Bone", "Ethereal Relic", "Shard of Ascension", "Veilstone"] },
  // --- Frozen Crypts (Norse) ---
  ...
  { name: "Savage Phantom of Norse", description: "A mythic phantom of pure destruction.", baseHp: 520, baseAttack: 32, baseDefense: 18, rarity: "MYTHIC", lootDrops: ["Astral Sigil", "Shard of Ascension", "Ethereal Relic"] },
  ...
  { name: "Lurking Warden of Egyptian", description: "A mythic warden of the dunes.", baseHp: 480, baseAttack: 29, baseDefense: 17, rarity: "MYTHIC", lootDrops: ["Shard of Ascension", "Veilstone", "Ethereal Relic", "Mythic Beast Bone"] },
  ...
  { name: "Dire Beast of Cosmic", description: "A rare beast of the astral caverns.", baseHp: 310, baseAttack: 23, baseDefense: 14, rarity: "RARE", lootDrops: ["Runed Talisman", "Bone Carving", "Rare Beast Fang"] },
